...
This MCP (Model Content Protocol) server provides access to Amazon Simple Notification Service API functionality through HTTP, HTTPS, and STDIO transport modes.
